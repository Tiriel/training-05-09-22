 ...
 */
final class Version20220908121651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , price NUMERIC(4, 2) NOT NULL, imdb_id VARCHAR(50) DEFAULT NULL, rated VARCHAR(10) DEFAULT NULL, CONSTRAINT FK_1D5EF26F55B127A4 FOREIGN KEY (added_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
